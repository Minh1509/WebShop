                ...
                <div className="row hero">
                    <div className="col-lg-3 hero_detail">
                        ...
                        <ul className={showMenu ? "" : "hidden"}>
                            <li>
                                <Link to={ROUTER.USER.PRODUCT}>Thịt</Link>
                            </li>
                            <li>
                                <Link to={ROUTER.USER.PRODUCT}>Rau củ</Link>
                            </li>
                            <li>
                                <Link to={ROUTER.USER.PRODUCT}>Cá</Link>
                            </li>
                            <li>
                                <Link to={ROUTER.USER.PRODUCT}>Nước uống</Link>
                            </li>
                        </ul>
                    </div>
